...
Container image publication for the AWS Outbound JWT Proxy: how release-built linux binaries are packaged into a minimal multi-arch image, which registries and tags are used, and how container documentation is kept in sync with the published image.
