...
Configuration of the Zensical-based documentation site for the AWS Outbound JWT Proxy: project identity, repository integration, navigation, and build hygiene as expressed in `zensical.toml` and the build pipeline.
