...
Coverage and sourcing rules for the user-facing documentation set published to the docs site: which pages must exist, where their content comes from, and how `README.md` relates to the published docs.
