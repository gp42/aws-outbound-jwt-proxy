...
Continuous-integration workflow and dependency-update automation for the repository: which workflows run on which events, what must pass before merge, and how third-party updates (Go modules and GitHub Actions) are proposed.
