...
Conventional Commits enforcement for the repository: which commit messages are accepted, how the validation hook is installed, and which commit types are recognized.
